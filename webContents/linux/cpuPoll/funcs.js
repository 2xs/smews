...
function doAjax(ajaxTarget,ajaxCallBack,timeout,timeoutCallBack){
	...
	xhr.send(null);
//~ currVal += 100 * (0.5 - Math.random());
//~ currVal = Math.min(currVal,1024);
//~ currVal = Math.max(currVal,0);
//~ setTimeout(function() { ajaxCallBack(200,currVal); },100)
}
